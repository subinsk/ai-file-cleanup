/**
 * Script to run migrations on both local and Neon databases using Prisma
 * Run with: node scripts/migrate-both-dbs.js
 */
...
const NEON_DB_URL = 'postgresql://neondb_owner:npg_8SR4galwVZcW@ep-divine-fire-a193qywk-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
...
async function runMigrationOnDatabase(dbUrl, dbName) {
