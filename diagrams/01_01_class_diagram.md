...
Shows the static structure of the system with classes, attributes, methods, and relationships.

## Source

This diagram is maintained in `diagrams/mermaid/01_class.mmd`.

To update this diagram:
1. Edit the source file: `diagrams/mermaid/01_class.mmd`
...
```markdown
```mermaid
{{< include "diagrams/mermaid/01_class.mmd" >}}
```
```
