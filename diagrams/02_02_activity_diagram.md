...
Shows the workflow and decision points in the scan and cleanup processes.

## Source

This diagram is maintained in `diagrams/mermaid/02_activity.mmd`.

To update this diagram:
1. Edit the source file: `diagrams/mermaid/02_activity.mmd`
...
```markdown
```mermaid
{{< include "diagrams/mermaid/02_activity.mmd" >}}
```
```
